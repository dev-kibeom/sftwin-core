...
class GlobalErrorCodes:
    ...
    # Aliases for Shared Security
    ERR_SHARED_UNAUTHORIZED = "ERR_COMMON_UNAUTHORIZED"
    ERR_SHARED_FORBIDDEN = "ERR_COMMON_FORBIDDEN"
    ...
    ERR_TWIN_ASSET_LOCKED = "ERR_TWIN_ASSET_LOCKED"
