"""
===============================================================================
[File Name] i_sensor_log_parser_port.py
[Location ] /src/asset_twin/twin_reconstruction/ports/outbound/i_sensor_log_parser_port.py
[Description]
...
class ISensorLogParserPort(ABC):
    @abstractmethod
